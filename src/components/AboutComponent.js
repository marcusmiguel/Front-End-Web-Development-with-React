...
function RenderLeader({ leader }) {
  return (
    <Fade in>
      <div key={leader.id} className="col">
        <Media tag="li">
          <Media left middle>
...
function About({ propsleaders, leadersLoading, leadersErrMess }) {
  if (leadersLoading) {
    return (
    ...
    return (
      <div className="container">
        ...
        <div className="row row-content">
          ...
          <div className="col-12">
            <Stagger in>
              <Media list>{leadersErrMess}</Media>
            </Stagger>
          </div>
        </div>
      </div>
    ...
    const leaders = propsleaders.leaders.map((leader) => (
